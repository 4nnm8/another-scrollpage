var $ = function(a) {
	...
	touchEndX = 0,
    touchSensitivity = 5,
	scrollspeed = 1000; // VITESSE DE DEFILEMENT
...
function callbefore(n) {
    switch (n + 1) {
      case 1: console.log('Heading page 1');break;
      case 2: console.log('Heading page 2');break;
	  case 3: console.log('Heading page 3');break;
	  case 4: console.log('Heading page 4');break;
    }
}

function callback(n) {
    switch (n + 1) {
      case 1: console.log('Arrived page 1');break;
      case 2: console.log('Arrived page 2');break;
	  case 3: console.log('Arrived page 3');break;
	  case 4: console.log('Arrived page 4');break;
    }
}
...
$('.link').on('click', function(event) {
  event.preventDefault();
  var nb = Number(this.getAttribute('href').replace('#', '')) - 1;
  wait = false;
  go(nb);
});
